...
const ManageStaff = () => {
  ...
  const getDocDetailsList = async () => {
    ...
    try {
      const { data } = await axios.get(
        `https://laxmibhawanidentalhospital.dentalguru.software/api/v1/super-admin/getEmployeeDataByBranch/${branch_name}`,
        {
          headers: {
  ...
  const enrollEmployeeDetails = async (e) => {
    ...
    try {
      ...
      const { data } = await axios.post(
        "https://laxmibhawanidentalhospital.dentalguru.software/api/v1/super-admin/enroll-employee",
        formData,
        {
          headers: {
  ...
  const addEmployeeTimeline = async () => {
    try {
      const response = await axios.post(
        `https://laxmibhawanidentalhospital.dentalguru.software/api/v1/super-admin/addSuperAdminNotify`,
        {
  ...
  const editEmployeeData = async (eid) => {
    ...
    try {
      const response = await axios.put(
        `https://laxmibhawanidentalhospital.dentalguru.software/api/v1/super-admin/editEmployeeDetails/${branch_name}/${eid}`,
        { status: "Approved" },
        {
          headers: {
            "Content-Type": "multipart/form-data",
