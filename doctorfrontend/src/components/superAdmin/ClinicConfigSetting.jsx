...
const ClinicConfigSetting = () => {
  ...
  const SubmitDocPaymentChange = async (e) => {
    ...
    try {
      const res = await axios.put(
        `https://laxmibhawanidentalhospital.dentalguru.software/api/v1/super-admin/updateDoctorPaymentAllowSetting/${branch_name}`,
        {
  ...
  const getBranchData = async () => {
    try {
      const { data } = await axios.get(
        `https://laxmibhawanidentalhospital.dentalguru.software/api/v1/super-admin/getBranchDetailsByBranch/${branch_name}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const getInsuranceList = async () => {
    try {
      const { data } = await axios.get(
        `https://laxmibhawanidentalhospital.dentalguru.software/api/v1/super-admin/getInsuranceList/${branch_name}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const insertInsurance = async (e) => {
    ...
    try {
      const res = await axios.post(
        `https://laxmibhawanidentalhospital.dentalguru.software/api/v1/super-admin/addInsuranceCompany/${branch_name}`,
        addIns,
        {
          headers: {
            "Content-Type": "application/json",
  ...
  const updateInsuranceData = async (e) => {
    ...
    try {
      const res = await axios.put(
        `https://laxmibhawanidentalhospital.dentalguru.software/api/v1/super-admin/updateInsuranceDetails/${selected.ins_id}/${branch_name}`,
        upIns,
        {
          headers: {
            "Content-Type": "application/json",
    ...
    try {
      ...
      if (confirm) {
        const del = await axios.delete(
          `https://laxmibhawanidentalhospital.dentalguru.software/api/v1/super-admin/deleteInsurance/${id}/${branch_name}`,
          {
            headers: {
              "Content-Type": "application/json",
              Authorization: `Bearer ${token}`,
