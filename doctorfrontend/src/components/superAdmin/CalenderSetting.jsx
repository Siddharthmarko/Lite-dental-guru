...
const CalenderSetting = () => {
  ...
  const updateBranchDetails = async (e) => {
    ...
    try {
      const response = await axios.put(
        `https://laxmibhawanidentalhospital.dentalguru.software/api/v1/super-admin/updateBranchCalenderSetting/${branch_name}`,
        upData,
        {
          headers: {
            "Content-Type": "application/json",
  ...
  const getHolidayList = async () => {
    try {
      const { data } = await axios.get(
        `https://laxmibhawanidentalhospital.dentalguru.software/api/v1/super-admin/getHolidays/${branch_name}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const addHolidays = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://laxmibhawanidentalhospital.dentalguru.software/api/v1/super-admin/addBlockDays",
        holidays,
        {
          headers: {
            "Content-Type": "application/json",
  ...
  const updateHolidetails = async (e) => {
    ...
    try {
      const response = await axios.put(
        `https://laxmibhawanidentalhospital.dentalguru.software/api/v1/super-admin/updateHolidays/${selected.holiday_id}`,
        upHolidays,
        {
          headers: {
            "Content-Type": "application/json",
  ...
  const deleteHoliday = async (id) => {
    ...
    try {
      const response = await axios.delete(
        `https://laxmibhawanidentalhospital.dentalguru.software/api/v1/super-admin/deleteHolidays/${id}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
