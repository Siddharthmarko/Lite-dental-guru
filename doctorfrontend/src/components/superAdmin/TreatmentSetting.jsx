...
const TreatmentSetting = () => {
  ...
  const getTreatmentDataViaId = async () => {
    try {
      const { data } = await axios.get(
        `https://laxmibhawanidentalhospital.dentalguru.software/api/v1/super-admin/getTreatmentViaId/${trID}`,
        {
          headers: {
  ...
  const getProcedure = async () => {
    try {
      const { data } = await axios.get(
        `https://laxmibhawanidentalhospital.dentalguru.software/api/v1/super-admin/getProcedureList`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const addTreatments = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://laxmibhawanidentalhospital.dentalguru.software/api/v1/super-admin/addTreatment",
        treatData,
        {
          headers: {
            "Content-Type": "application/json",
  ...
  const getTreatmentList = async () => {
    ...
    try {
      const { data } = await axios.get(
        "https://laxmibhawanidentalhospital.dentalguru.software/api/v1/super-admin/getTreatmentList",
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const updateTreatmentDetails = async (e, id) => {
    ...
    try {
      const response = await axios.put(
        `https://laxmibhawanidentalhospital.dentalguru.software/api/v1/super-admin/updateTreatmentDetails/${id}`,
        updateTreatVal,
        {
          headers: {
            "Content-Type": "application/json",
    ...
    try {
      ...
      if (isConfirmed) {
        const response = await axios.delete(
          `https://laxmibhawanidentalhospital.dentalguru.software/api/v1/super-admin/deleteTreatment/${id}`,
          {
            headers: {
              "Content-Type": "application/json",
              Authorization: `Bearer ${token}`,
