...
function SecurityAmount() {
    ...
    if (name === "appointment_id") {
      try {
        const { data } = await axios.get(
          `https://laxmibhawanidentalhospital.dentalguru.software/api/v1/accountant/getAppointmentDetailsViaID/${value}`
        );
  ...
  const insertSecurityAmount = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://laxmibhawanidentalhospital.dentalguru.software/api/v1/accountant/addSecurityAmount",
        addSecurityAmount
      );
  ...
  const getSecurityAmountList = async () => {
    ...
    try {
      const { data } = await axios.get(
        `https://laxmibhawanidentalhospital.dentalguru.software/api/v1/receptionist/getSecurityAmountDataByBranch/${branch}`,
        {
          headers: {
  ...
  const makePaymentNow = async (id) => {
    try {
      const response = await axios.put(
        `https://laxmibhawanidentalhospital.dentalguru.software/api/v1/accountant/updateSecurityAmount/${id}`
      );
  ...
  const MakeRefund = async (e) => {
    ...
    try {
      setLoading(true);
      const response = await axios.put(
        `https://laxmibhawanidentalhospital.dentalguru.software/api/v1/receptionist/updateRefundAmount/${selected}`,
        {
  ...
  const paySecurityCash = async (e) => {
    ...
    try {
      setLoading(true);
      const response = await axios.put(
        `https://laxmibhawanidentalhospital.dentalguru.software/api/v1/receptionist/updatePatientSecurityAmt/${selected}`,
        updatedData,
        {
          headers: {
            "Content-Type": "application/json",
  ...
  //     try {
  //       const { data } = await axios.get(
  //         `https://laxmibhawanidentalhospital.dentalguru.software/api/v1/receptionist/getSecurityAmountDataBySID/${id}`
  //       );
  //       console.log(data);
  //       setOutStanding(data);
  //     } catch (error) {
  ...
  //     try{
  //       const response = await axios.get(`https://laxmibhawanidentalhospital.dentalguru.software/api/v1/receptionist/patient-securityAmt/${branch}`);
  //       console.log(response);
  ...
  const sendWhatsappTextOnly = async () => {
    try {
      ...
      const res = await axios.post(
        "https://laxmibhawanidentalhospital.dentalguru.software/api/v1/receptionist/sendWhatsapptextonly",
        formDetails,
        {
          headers: {
            "Content-Type": "application/json",
