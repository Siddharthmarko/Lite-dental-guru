  ...
  const getTodayAttendance = async () => {
    try {
      const response = await axios.get(
        `https://huzaifdentalclinic.dentalguru.software/api/v1/receptionist/getTodayAttendance/${branch_name}/${employee_ID}/${date}`,
        {
          headers: {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://huzaifdentalclinic.dentalguru.software/api/v1/receptionist/markAttendanceLogin",
        {
          branch_name,
          employee_ID,
          employee_name,
  ...
  const handleLogout = async () => {
    ...
    try {
      ...
      const response = await axios.put(
        "https://huzaifdentalclinic.dentalguru.software/api/v1/receptionist/markAttendanceLogout",
        {
          branch_name,
          employee_ID,
          employee_name,
