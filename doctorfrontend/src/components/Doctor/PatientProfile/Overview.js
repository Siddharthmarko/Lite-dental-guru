...
const Overview = () => {
  ...
  const getPresDetails = async () => {
    try {
      const { data } = await axios.get(
        `https://huzaifdentalclinic.dentalguru.software/api/doctor/getPrescriptionDetailsById/${pid}`
      );
      setPresData(data);
    } catch (error) {
      // console.log(error);
  ...
  const getPendingBillDetails = async () => {
    try {
      const { data } = await axios.get(
        `https://huzaifdentalclinic.dentalguru.software/api/doctor/getPatientBillByBranchAndId/${pid}`
      );
      // console.log(data);
  ...
  const getExamineDetails = async () => {
    try {
      const { data } = await axios.get(
        `https://huzaifdentalclinic.dentalguru.software/api/doctor/examinDetailsByPatId/${pid}`
      );
      // setExmData(data);
    } catch (error) {
      // console.log(error);
  ...
  const fetchLatestDentalPatientData = async () => {
    try {
      const { data } = await axios.get(
        `https://huzaifdentalclinic.dentalguru.software/api/doctor/getExaminationViaUhid/${branch}/${uhid}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const fetchLatestPrescriptionPatientData = async () => {
    try {
      const { data } = await axios.get(
        `https://huzaifdentalclinic.dentalguru.software/api/doctor/getPrescriptionViaUhid/${branch}/${uhid}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const fetchLatestBillPatientData = async () => {
    try {
      const response = await axios.get(
        `https://huzaifdentalclinic.dentalguru.software/api/doctor/get-patientBill-data/${uhid}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const onGoingTreat = async () => {
    try {
      const response = await axios.get(
        `https://huzaifdentalclinic.dentalguru.software/api/doctor/onGoingTreat/${uhid}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
