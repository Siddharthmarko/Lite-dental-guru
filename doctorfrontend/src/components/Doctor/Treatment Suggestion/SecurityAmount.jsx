...
const SecurityAmount = () => {
  ...
  const newGetFetchData = async () => {
    try {
      const resps = await axios.get(
        `https://huzaifdentalclinic.dentalguru.software/api/doctor/patient-security/${id}/${branch}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const getSecurityAmt = async () => {
    try {
      const resdata = await axios.get(
        `https://huzaifdentalclinic.dentalguru.software/api/doctor/getSecurityAmountByAppointmentId/${tpid}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  //   try {
  //     const response = await axios.put(`https://huzaifdentalclinic.dentalguru.software/api/doctor/update-security-amount/${sa_id}`, updatedata);
