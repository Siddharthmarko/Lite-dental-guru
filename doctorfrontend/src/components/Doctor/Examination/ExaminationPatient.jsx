...
const ExaminationPatientTest = ({ tpid }) => {
  ...
  const addChiefComList = async () => {
    try {
      const res = await axios.post(
        "https://laxmibhawanidentalhospital.dentalguru.software/api/doctor/addChiefComplainTOList",
  ...
  const handleSave = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://laxmibhawanidentalhospital.dentalguru.software/api/doctor/dentalPediatric",
        formData,
        {
          headers: {
            "Content-Type": "application/json",
