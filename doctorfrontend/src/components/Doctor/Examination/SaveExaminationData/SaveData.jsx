  ...
  const handleSubmit = async (id, e) => {
    ...
    try {
      const response = await axios.put(
        `https://huzaifdentalclinic.dentalguru.software/api/doctor/updatedentalPediatric/${id}`,
        formData,
        {
          headers: {
            "Content-Type": "application/json",
    ...
    try {
      ...
      if (confirmed) {
        const res = await axios.delete(
          `https://huzaifdentalclinic.dentalguru.software/api/doctor/deleteDentalPediatric/${id}`,
          {
            headers: {
              "Content-Type": "application/json",
              Authorization: `Bearer ${token}`,
