  ...
  const getPatientById = async () => {
    try {
      const { data } = await axios.get(
        `https://huzaifdentalclinic.dentalguru.software/api/doctor/get-Patient-by-id/${branch}/${uhid}`,
        {
          headers: {
  ...
  const addPackageTreat = async (updatedTreatData) => {
    ...
    try {
      const { data } = await axios.post(
        "https://huzaifdentalclinic.dentalguru.software/api/doctor/addTreatPackageDetails",
        updatedTreatData,
        {
          headers: {
            "Content-Type": "application/json",
