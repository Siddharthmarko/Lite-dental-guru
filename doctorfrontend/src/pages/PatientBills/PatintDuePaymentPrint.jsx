...
const PatintDuePaymentPrint = () => {
  ...
  const getBranchDetails = async () => {
    try {
      const { data } = await axios.get(
        `https://huzaifdentalclinic.dentalguru.software/api/doctor/getBranchDetails/${user.branch_name}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const secuirtyAmtBytpuhid = async () => {
    try {
      const { data } = await axios.get(
        `https://huzaifdentalclinic.dentalguru.software/api/doctor/getSecurityAmountDataByTPUHID/${tpid}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const getBillDetails = async () => {
    try {
      const { data } = await axios.get(
        `https://huzaifdentalclinic.dentalguru.software/api/doctor/getPatientBillsAndSecurityAmountByBranch/${user.branch_name}/${tpid}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const getTreatDetail = async () => {
    try {
      const { data } = await axios.get(
        `https://huzaifdentalclinic.dentalguru.software/api/doctor/getTreatmentDetailsViaTpid/${tpid}/${user.branch_name}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const updateRemainingSecurity = async () => {
    ...
    try {
      ...
      const response = await axios.put(
        `https://huzaifdentalclinic.dentalguru.software/api/doctor/updateRemainingSecurityAmount/${tpid}`,
        {
  ...
  const makePayment = async () => {
    ...
    try {
      const response = await axios.put(
        `https://huzaifdentalclinic.dentalguru.software/api/doctor/makeBillPayment/${tpid}/${user.branch_name}`,
        BillInput,
        {
          headers: {
            "Content-Type": "application/json",
  ...
  const completeTreatment = async () => {
    try {
      const res = await axios.put(
        `https://huzaifdentalclinic.dentalguru.software/api/doctor/updateTreatmentStatus/${user.branch_name}/${tpid}`,
