...
const PasswordReset = () => {
  ...
  const verifyOtpAdmin = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://laxmibhawanidentalhospital.dentalguru.software/api/doctor/verifyOtp",
        {
          email,
          otp,
        }
  ...
  const changePassword = async (e) => {
    ...
    try {
      const response = await axios.put(
        "https://laxmibhawanidentalhospital.dentalguru.software/api/doctor/resetPassword",
        {
          email,
