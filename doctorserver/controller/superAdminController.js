...
const updateDoctorPaymentAllowSetting = (req, res) => {
  ...
  const EnrollEmployee = async (req, res) => {
    try {
      ...
      const imageUrl = `https://jaipurdentalhospital.dentalguru.software/empProfilePicture/${empProfilePicture?.filename}`;
...
const updateTreatmentDetails = (req, res) => {
  ...
  const updateBranchDetails = (req, res) => {
    try {
      ...
      const urlAdd = "https://jaipurdentalhospital.dentalguru.software/branchHeadFootImg";
